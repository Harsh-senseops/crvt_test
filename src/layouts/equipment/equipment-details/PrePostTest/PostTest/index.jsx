                        ...
                        <Grid item mr={6} xs={12} sm={12} md={6} lg={6} xl={6}>
                          ...
                          >
                            Initial
                                ...
                                <MDTypography
                                  style={{background: "#394258",display: "flex",justifyContent: "center",alignItems: "center",borderRadius: "4px",fontSize: "13px",width:"100%",padding:"8px 0px"
                                  }}
                                  >
                                  {val.value.a_value}
                                </MDTypography>
                           ...
                           { val.value.min && val.value.max?<><Grid item xs={4} sm={4} md={2} lg={2} xl={2}>
                              ...
                              >
                                ...
                                <MDTypography
                                  style={{background: "#394258",display: "flex",justifyContent: "center",borderRadius: "4px",marginTop: "4px",fontSize: "13px",padding:"8px 0px"
                                  }}
                                >
                                  {val.value.min}
                                </MDTypography>
