...
export default function VibrationTest({ details, componentName, id }) {
            ...
            updateVibrationErd({
              ...
              if (res.data) {
                alertAndLoaders(
                  "UNSHOW_ALERT",
                  dispatch,
                  "Vibration Test Details Are Saved... ",
                  "success"
                );
              }
            });
  ...
  const toggleTrue = () => {
    saveVibartionStatus({
      ...
      toggleEnable
        ? alertAndLoaders("UNSHOW_ALERT", dispatch, "Vibration Test Is Disabled... ", "warning")
        : alertAndLoaders("UNSHOW_ALERT", dispatch, "Vibartion Test Is Enabled... ", "success");
    });
  };
