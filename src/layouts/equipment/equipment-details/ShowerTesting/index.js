...
export default function ShowerTesting({ details, componentName, id }) {
  ...
  const toggleTrue = () => {
    saveShowerStatus({
      ...
      toggleEnable
        ? alertAndLoaders("UNSHOW_ALERT", dispatch, "Shower Test Is Disabled... ", "warning")
        : alertAndLoaders("UNSHOW_ALERT", dispatch, "Shower Test Is Enabled... ", "success");
    });
  };
  return (
    <>
