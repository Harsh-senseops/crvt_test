    ...
    <CardHeader
        action={
           ...
           {role.roles === 3 && <MuiToggleButton style={{height: '30px', border: 'none'}}
             ...
             onChange={toggleTrue}
             >
             <p style={{fontSize: '0.75rem', color: toggleEnable ? '#429D46':'#d50000', fontWeight: 'bold'}}>
        ...
        subheader={toggleEnable ? <MDTypography style={{color: 'green', fontSize: '14px', paddingTop: '1%'}}>Oven Test is Enabled</MDTypography> : <MDTypography style={{color: '#D9534F', fontSize: '14px', paddingTop: '1%'}}>No Oven Test</MDTypography>}
