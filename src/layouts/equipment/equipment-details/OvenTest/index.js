...
import { SAVE_OVEN_DETAILS } from 'apis/queries';
import { OVEN_TEST_DETAILS } from 'apis/queries';
import { ADD_OVEN_STATUS } from 'apis/queries';
...
export default function OvenTest({ details, componentName, id }) {
  ...
  const toggleTrue = () => {
    ...
    saveOvenStatus({
      ...
      toggleEnable ? alertAndLoaders("UNSHOW_ALERT", dispatch, "Oven Test Is Disabled...", "warning") : alertAndLoaders("UNSHOW_ALERT", dispatch, "Oven Test Is Enabled... ", "success")
    })
  }
  return (
    <>
      <Card style={{ marginTop: '2%' }}>
        <CardHeader
            ...
            <div>
              ...
              >
                <p style={{ fontSize: '0.75rem', color: 'white', fontWeight: 'bold' }}>
                  {toggleEnable ? "Enabled" : "Disabled"}</p>
              </MuiToggleButton>}
          ...
          title={<MDTypography variant="h6" fontWeight="medium">Oven Test</MDTypography>}
          subheader={toggleEnable ? <MDTypography style={{ color: 'green', fontSize: '14px', paddingTop: '1%' }}>Oven Test is Enabled</MDTypography> : <MDTypography style={{ color: 'red', fontSize: '14px', paddingTop: '1%' }}>No Oven Test</MDTypography>}
