...
import { VIBRATION_YEARLY_PLANNER } from "apis/queries";
// import "./index.css"
...
export default function Vibration() {
  ...
  const [vibrationYearlyPLanner, rexVibratioinYearlyPLanner] = useSubscription({
    query: VIBRATION_YEARLY_PLANNER,
    // pause: shouldPause,
  });
  const { data, fetching, error } = vibrationYearlyPLanner;
  ...
  React.useEffect(() => {
    ...
    if (vibrationYearlyPLanner.data) {
      const monthNames = [
        "April",
        "May",
        "June",
      ...
      let tempArr = [];
      vibrationYearlyPLanner.data.allVibrationYearlyPlanners.nodes.map((val, i) => {
