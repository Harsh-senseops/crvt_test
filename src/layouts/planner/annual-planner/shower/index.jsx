...
import { SHOWER_YEARLY_PLANNER } from "apis/queries";
// import "./index.css"
...
export default function Shower() {
  ...
  const [showerYearlyPlanner, rexRoYearlyPlanner] = useSubscription({
  ...
  React.useEffect(() => {
    if (showerYearlyPlanner.data) {
      ...
      console.log(data);
      let tempArr = [];
      showerYearlyPlanner.data.allShowerYearlyPlanners.nodes.map((val, i) => {
