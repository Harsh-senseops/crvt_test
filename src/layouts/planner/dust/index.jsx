...
import { DUST_YEARLY_PLANNER } from "apis/queries";
// import "./index.css"
...
export default function Dust() {
  ...
  const [dustYearlyPlanner, rexDustYearlyPlanner] = useSubscription({
    query: DUST_YEARLY_PLANNER,
    // pause: shouldPause,
  });
  const { data, fetching, error } = dustYearlyPlanner;
  ...
  React.useEffect(() => {
    ...
    if (dustYearlyPlanner.data) {
      ...
      let tempArr = [];
      dustYearlyPlanner.data.allDustYearlyPlanners.nodes.map((val, i) => {
